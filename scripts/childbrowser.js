...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>ChildBrowser/www/childbrowser.js at master · alunny/ChildBrowser</title>
...
<meta content="16mH++IMRWhF48mfA6Z0SXLu6AUXotT5z3Al9CVsqBc=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-5a80bdfa39bad96522873dfd72fa56c72e6675b3.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="affaac5ba4a5dec7537bc81ec484528d">
        ...
        <link data-pjax-transient rel='permalink' href='/alunny/ChildBrowser/blob/f15e20de309f1dce58f7f1c347935d8356b937b3/www/childbrowser.js'>
  ...
  <meta content="48361" name="octolytics-dimension-user_id" /><meta content="alunny" name="octolytics-dimension-user_login" /><meta content="3402953" name="octolytics-dimension-repository_id" /><meta content="alunny/ChildBrowser" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="3402953" name="octolytics-dimension-repository_network_root_id" /><meta content="alunny/ChildBrowser" name="octolytics-dimension-repository_network_root_nwo" />
...
<input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" autocapitalize="off"
    ...
    data-username="gustavodenis"
      data-repo="alunny/ChildBrowser"
      data-branch="master"
      data-sha="d4905a8d43f149fdff0855a904e3a63a898cec4c"
  >

    <input type="hidden" name="nwo" value="alunny/ChildBrowser" />
...
<ul class="dropdown-menu">
  ...
  <li>
    ...
    <li class="section-title">
      <span title="alunny/ChildBrowser">This repository</span>
    </li>
      <li>
        <a href="/alunny/ChildBrowser/issues/new"><span class="octicon octicon-issue-opened"></span> New issue</a>
      </li>
</ul>
...
<ul class="pagehead-actions">
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <a href="/alunny/ChildBrowser/unstar"
      class="minibutton with-count js-toggler-target star-button starred upwards"
      title="Unstar this repository" data-remote="true" data-method="post" rel="nofollow">
      <span class="octicon octicon-star-delete"></span><span class="text">Unstar</span>
    </a>

    <a href="/alunny/ChildBrowser/star"
      class="minibutton with-count js-toggler-target star-button unstarred upwards"
      title="Star this repository" data-remote="true" data-method="post" rel="nofollow">
      <span class="octicon octicon-star"></span><span class="text">Star</span>
    </a>

      <a class="social-count js-social-count" href="/alunny/ChildBrowser/stargazers">
        96
      </a>
  </div>
        ...
        <li>
          <a href="/alunny/ChildBrowser/fork" class="minibutton with-count js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="octicon octicon-git-branch-create"></span><span class="text">Fork</span>
          </a>
          <a href="/alunny/ChildBrowser/network" class="social-count">102</a>
        </li>
        ...
        <h1 itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="entry-title public">
          ...
          <span class="author">
            <a href="/alunny" class="url fn" itemprop="url" rel="author"><span itemprop="title">alunny</span></a>
          </span>
          <span class="repohead-name-divider">/</span>
          <strong><a href="/alunny/ChildBrowser" class="js-current-repository js-repo-home-link">ChildBrowser</a></strong>
  ...
  <div class="sunken-menu-contents">
    <ul class="sunken-menu-group">
      <li class="tooltipped leftwards" title="Code">
        <a href="/alunny/ChildBrowser" aria-label="Code" class="selected js-selected-navigation-item sunken-menu-item" data-gotokey="c" data-pjax="true" data-selected-links="repo_source repo_downloads repo_commits repo_tags repo_branches /alunny/ChildBrowser">
          <span class="octicon octicon-code"></span> <span class="full-word">Code</span>
          <img alt="Octocat-spinner-32" class="mini-loader" height="16" src="https://github.global.ssl.fastly.net/images/spinners/octocat-spinner-32.gif" width="16" />
</a>      </li>

        <li class="tooltipped leftwards" title="Issues">
          <a href="/alunny/ChildBrowser/issues" aria-label="Issues" class="js-selected-navigation-item sunken-menu-item js-disable-pjax" data-gotokey="i" data-selected-links="repo_issues /alunny/ChildBrowser/issues">
      ...
      <li class="tooltipped leftwards" title="Pull Requests">
        <a href="/alunny/ChildBrowser/pulls" aria-label="Pull Requests" class="js-selected-navigation-item sunken-menu-item js-disable-pjax" data-gotokey="p" data-selected-links="repo_pulls /alunny/ChildBrowser/pulls">
        ...
        <li class="tooltipped leftwards" title="Wiki">
          <a href="/alunny/ChildBrowser/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item" data-pjax="true" data-selected-links="repo_wiki /alunny/ChildBrowser/wiki">
    ...
    <ul class="sunken-menu-group">
      ...
      <li class="tooltipped leftwards" title="Pulse">
        <a href="/alunny/ChildBrowser/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-pjax="true" data-selected-links="pulse /alunny/ChildBrowser/pulse">
          <span class="octicon octicon-pulse"></span> <span class="full-word">Pulse</span>
          <img alt="Octocat-spinner-32" class="mini-loader" height="16" src="https://github.global.ssl.fastly.net/images/spinners/octocat-spinner-32.gif" width="16" />
</a>      </li>

      <li class="tooltipped leftwards" title="Graphs">
        <a href="/alunny/ChildBrowser/graphs" aria-label="Graphs" class="js-selected-navigation-item sunken-menu-item" data-pjax="true" data-selected-links="repo_graphs repo_contributors /alunny/ChildBrowser/graphs">
          <span class="octicon octicon-graph"></span> <span class="full-word">Graphs</span>
          <img alt="Octocat-spinner-32" class="mini-loader" height="16" src="https://github.global.ssl.fastly.net/images/spinners/octocat-spinner-32.gif" width="16" />
</a>      </li>

      <li class="tooltipped leftwards" title="Network">
        <a href="/alunny/ChildBrowser/network" aria-label="Network" class="js-selected-navigation-item sunken-menu-item js-disable-pjax" data-selected-links="repo_network /alunny/ChildBrowser/network">
...
<div class="clone-url open"
  ...
  <div class="clone-url-box">
    <input type="text" class="clone js-url-field"
           value="https://github.com/alunny/ChildBrowser.git" readonly="readonly">

    <span class="js-zeroclipboard url-box-clippy minibutton zeroclipboard-button" data-clipboard-text="https://github.com/alunny/ChildBrowser.git" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
...
<div class="clone-url "
  ...
  <div class="clone-url-box">
    <input type="text" class="clone js-url-field"
           value="git@github.com:alunny/ChildBrowser.git" readonly="readonly">

    <span class="js-zeroclipboard url-box-clippy minibutton zeroclipboard-button" data-clipboard-text="git@github.com:alunny/ChildBrowser.git" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
...
<div class="clone-url "
  ...
  <div class="clone-url-box">
    <input type="text" class="clone js-url-field"
           value="https://github.com/alunny/ChildBrowser" readonly="readonly">

    <span class="js-zeroclipboard url-box-clippy minibutton zeroclipboard-button" data-clipboard-text="https://github.com/alunny/ChildBrowser" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
...
<p class="clone-options">You can clone with
  ...
  <a href="github-windows://openRepo/https://github.com/alunny/ChildBrowser" class="minibutton sidebar-button">
    <span class="octicon octicon-device-desktop"></span>
    Clone in Desktop
  </a>

              <a href="/alunny/ChildBrowser/archive/master.zip"
...
<!-- blob contrib key: blob_contributors:v21:0e7f3c714967cf0d09ecdfe7b2185aeb -->

<p title="This is a placeholder element" class="js-history-link-replace hidden"></p>

<a href="/alunny/ChildBrowser/find/master" data-pjax data-hotkey="t" class="js-show-file-finder" style="display:none">Show File Finder</a>
...
<div class="select-menu js-menu-container js-select-menu" >
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/blob/master/www/childbrowser.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/blob/newcontrols/www/childbrowser.js"
                 data-name="newcontrols"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
                 title="newcontrols">newcontrols</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/blob/one-x/www/childbrowser.js"
                 data-name="one-x"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/blob/three-x/www/childbrowser.js"
                 data-name="three-x"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
                 title="three-x">three-x</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/blob/two-x/www/childbrowser.js"
                 data-name="two-x"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/4.0.0/www/childbrowser.js"
                 data-name="4.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/3.0.4/www/childbrowser.js"
                 data-name="3.0.4"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/3.0.3/www/childbrowser.js"
                 data-name="3.0.3"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/3.0.2/www/childbrowser.js"
                 data-name="3.0.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/3.0.1/www/childbrowser.js"
                 data-name="3.0.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/3.0.0/www/childbrowser.js"
                 data-name="3.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/2.1.0/www/childbrowser.js"
                 data-name="2.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/2.0.1/www/childbrowser.js"
                 data-name="2.0.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/2.0.0/www/childbrowser.js"
                 data-name="2.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/1.0.2/www/childbrowser.js"
                 data-name="1.0.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/1.0.1/www/childbrowser.js"
                 data-name="1.0.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/alunny/ChildBrowser/tree/1.0.0/www/childbrowser.js"
                 data-name="1.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
  ...
  <div class="breadcrumb">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/alunny/ChildBrowser" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">ChildBrowser</span></a></span></span><span class="separator"> / </span><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/alunny/ChildBrowser/tree/master/www" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">www</span></a></span><span class="separator"> / </span><strong class="final-path">childbrowser.js</strong> <span class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="www/childbrowser.js" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://1.gravatar.com/avatar/fa2f1cb81dddc504c69ade73892d73ea?d=https%3A%2F%2Fidenticons.github.com%2F3ebe2a87a58cf391399b0bf0cb53c8ae.png&amp;r=x&amp;s=140" width="24" />
    <span class="author"><a href="/alunny" rel="author">alunny</a></span>
    <time class="js-relative-date" datetime="2013-02-06T21:51:33-08:00" title="2013-02-06 21:51:33">February 06, 2013</time>
    <div class="commit-title">
        <a href="/alunny/ChildBrowser/commit/b5592e9b6df62bd0d62a84ee8fd09e5d0050414f" class="message" data-pjax="true" title="adding semicolon, for consistency

fixes #13">adding semicolon, for consistency</a>
    </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img height="24" src="https://1.gravatar.com/avatar/fa2f1cb81dddc504c69ade73892d73ea?d=https%3A%2F%2Fidenticons.github.com%2F3ebe2a87a58cf391399b0bf0cb53c8ae.png&amp;r=x&amp;s=140" width="24" />
    ...
    <div class="meta">
      <div class="info">
        ...
        <span class="mode" title="File Mode">file</span>
          <span>120 lines (106 sloc)</span>
        <span>3.446 kb</span>
      </div>
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards"
               href="github-windows://openRepo/https://github.com/alunny/ChildBrowser?branch=master&amp;filepath=www%2Fchildbrowser.js" title="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton tooltipped upwards"
                   title="Clicking this button will automatically fork this project so you can edit the file"
                   href="/alunny/ChildBrowser/edit/master/www/childbrowser.js"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/alunny/ChildBrowser/raw/master/www/childbrowser.js" class="button minibutton " id="raw-url">Raw</a>
            <a href="/alunny/ChildBrowser/blame/master/www/childbrowser.js" class="button minibutton ">Blame</a>
          <a href="/alunny/ChildBrowser/commits/master/www/childbrowser.js" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/alunny/ChildBrowser/delete/master/www/childbrowser.js"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.03615s from github-fe135-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
      ...
      <textarea name="fullscreen-contents" id="fullscreen-contents" class="js-fullscreen-contents" placeholder="" data-suggester="fullscreen_suggester"></textarea>
          <div class="suggester-container">
              <div class="suggester fullscreen-suggester js-navigation-container" id="fullscreen_suggester"
                 data-url="/alunny/ChildBrowser/suggestions/commit">
              </div>
          </div>
    </div>
  </div>
